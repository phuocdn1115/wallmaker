...
import com.app.photomaker.startup.FirebaseConfigureInitializer
import com.app.photomaker.utils.extension.getDeviceId
import com.blankj.utilcode.util.NetworkUtils

class ConnectionLiveData(private val context: Context) : LiveData<Boolean>() {
    private val TAG = ConnectionLiveData::class.simpleName
    ...
    private fun updateConnection() {
        ...
        if (ApplicationContext.getNetworkContext().isNetworkConnected != NetworkUtils.isConnected() || !NetworkUtils.isConnected()) {
            Log.d(TAG, "POST_INTERNET::updateConnection: ${activeNetwork?.isConnectedOrConnecting}")
