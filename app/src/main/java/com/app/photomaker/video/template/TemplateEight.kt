...
class TemplateEight(template: Template, private val photoList: MutableList<PhotoData>) :
    ...
    override fun process(): PhotoMovie<*>? {
        ...
        template.script?.forEach { segmentData ->
            ...
            } else if (segmentData.segmentType == SegmentType.THAW_SEGMENT.type || segmentData.segmentType == SegmentType.SCALE_TRANS_SEGMENT.type) {
