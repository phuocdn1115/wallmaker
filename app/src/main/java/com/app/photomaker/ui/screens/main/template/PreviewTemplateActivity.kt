...
import com.app.photomaker.databinding.ActivityPreviewTemplateBinding
...
import com.app.photomaker.ui.screens.preview_home.PreviewActivityVM
...
class PreviewTemplateActivity : BaseActivity<ActivityPreviewTemplateBinding>() {
    ...
    private fun setupUI() {
        configTemplateVideo()
        GlideHandler.setImageFormUrl(binding.imgThumbPreview,  "${ApplicationContext.getNetworkContext().videoURL}${myTemplate?.thumbUrlImageString()}")
    }
