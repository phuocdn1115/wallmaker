...
import com.app.photomaker.databinding.ItemAddImageBinding
import com.app.photomaker.databinding.ItemImageSelectedHorizontalBinding
import com.app.photomaker.model.ImageSelected
import com.app.photomaker.utils.AnimationAppUtils.pushDownClickAnimation
        ...
        return when(viewType){
            IMAGE_SELECTED ->{
                val binding = DataBindingUtil.inflate(layoutInflater,
                    R.layout.item_image_selected_horizontal, parent, false) as ItemImageSelectedHorizontalBinding
                ImageSelectedViewHolder(binding)
            }
            else ->{
                val binding = DataBindingUtil.inflate(layoutInflater,
                    R.layout.item_add_image, parent, false) as ItemAddImageBinding
